def main(fileName,schoolName,outputName,OutputFile,OutputFileDB):
	...
	from callRailsApp import callRailsApp
...
# python OSM_All.py schools_full.xml "CUNY Hunter College" testOutput.txt OutputFile.txt OutputFileDB.txt
